<script>
    ...
    function addaddressmodel() {
        document.querySelector(".launch2").click();
    }
    ...
    function addaddress() {
        $.ajax({
            ...
            type: "POST",
            data: {
                "streetname": document.querySelector("#Streetname2").value,
                "house": document.querySelector("#Housenumber2").value,
                "postal": document.querySelector("#inputCity2").value,
                "city": document.querySelector("#inputState2").value,
