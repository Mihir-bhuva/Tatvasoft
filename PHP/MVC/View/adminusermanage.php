...
<body>
    ...
    <main>
        <div class="tables">
            ...
            <div>
                ...
                <div class="user-info">
                    <input type="" name="Service ID" id="UserName" placeholder="UserName">
                    <select class="user-status" name="" id="status">
                        <option value="">UserType</option>
                        <option value="Admin">Admin</option>
                        <option value="Customer">Customer</option>
                        <option value="ServiceProvider">Service Provider</option>
                    </select>
                    <input type="" name="Service ID" id="PhoneNumber" placeholder="Phone Number">
                    <input type="" name="Service ID" id="PostalCode" placeholder="Postal Code">
                    <input type="" name="Service ID" id="Email" placeholder="Email">
                    ...
                    <input type="text" class="from date-time" placeholder="From Date">
                    <!-- <div >
                        <img src="assets/images/admin-calendar-blue.png" alt="">
                    </div> -->
                    <input type="text" class="to date-time" placeholder="To Date">
                ...
                <!-- <div class="w3-dropdown-click">
                    ...
                    <div id="Demo" class="w3-dropdown-content w3-bar-block w3-border">
                        <a href="#" class="w3-bar-item w3-button">Active </a>
    ...
    <script>
        document.querySelector(".ServiceRequests").addEventListener("click", function() {
            window.location = 'http://localhost/Helperland/MVC/index.php?function=AdminServicerequest'
        })
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.9/umd/popper.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js"></script>
    <?php include 'adminusermanageajax.php'; ?>
