<script>
    ...
    $(document).ready(function() {
        ...
        $('#example').DataTable({
            "ajax": {
                type: "post",
                url: "https://localhost/Helperland/MVC/index.php?function=SPservicehistoryData",
                data: {
        ...
        document.querySelector(".buttons-excel span").innerHTML="Export"
        ...
        $('#example tbody').on('click', 'tr', function() {
            $.ajax({
                ...
                data: {
                    "userid": document.querySelectorAll("#example tr")[$('#example').DataTable().row(this).index() + 1].children[0].innerHTML
                },
                dataType: "json",
